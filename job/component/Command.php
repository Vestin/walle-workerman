...
class Command
{
     ...
     * @throws \Exception
     */
    public function __construct($project,$logger)
    {
        $this->logger = $logger;
        if ($project) {
